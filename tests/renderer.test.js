/**
 * @everystate/renderer: eventTest-based tests
 *
 * Tests pure functions AND store integration using @everystate/event-test.
 * Requires node_modules symlinks to @everystate/core and @everystate/event-test.
 */
